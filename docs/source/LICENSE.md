...
[SYLAP](https://github.com/VicidominiLab/BrightEyes-TTM/blob/v2.0/FPGA/ttm/hdl/sylap/):
...
[Data Receiver for Linux](https://github.com/VicidominiLab/BrightEyes-TTM/blob/v2.0/FPGAdataReceiver/linux/):
...
[Data Receiver for Windows](https://github.com/VicidominiLab/BrightEyes-TTM/blob/v2.0/dataReceiver/windows/):
is the License GPLv2 as derivates from cyusb_linux_1.0.5 which is part of
...
The a copy of the text of the above mentioned licenses can be found in the folder [license/](https://github.com/VicidominiLab/BrightEyes-TTM/blob/v2.0/license/).
